...
func _ready() -> void:
	...
	set_hint("Tap a soldier. Tap ground to move. Tap enemy to attack.")
...
func _build_ui() -> void:
	...
	_selected_label.custom_minimum_size = Vector2(180.0, 56.0)
	...
	_hint_label.custom_minimum_size = Vector2(560.0, 56.0)
	...
	_select_button.custom_minimum_size = Vector2(132.0, 58.0)
