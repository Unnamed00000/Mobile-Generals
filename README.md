...
Prototype 0.1 for an original mobile RTS inspired by classic real-time strategy pacing. This repository starts with Milestone 1: a playable match scene with a test map, angled RTS camera, touch/mouse camera controls, one Builder unit, selection, and movement commands.
...
- Milestone 2 next: construction placement, Power Plant, Barracks, War Factory.
- Later milestones: economy, production queues, army controls, combat, AI, minimap, Android polish.
